...
public abstract class QueryOperator implements Iterable<Record> {
    ...
    /**
     * Sets the output schema of this operator. This should match the schema
     * of the records of the iterator obtained
     * by calling execute().
     */
     ...
     */
    public static BacktrackingIterator<Record> getBlockIterator(Iterator<Record> records,
                                                                Schema schema, int maxPages) {
