...
public class SortMergeOperator extends JoinOperator {
    ...
    private class SortMergeIterator implements Iterator<Record> {
        ...
        */
        ...
        private boolean marked; // to see if the iterator is adjusted...
        ...
        private Record fetchNextRecord() {
            ...
            if (!this.marked) {
                ...
                this.marked = true; // tell that it has been adjusted
            }
            ...
            if (compare(leftRecord, rightRecord) == 0) {
                ...
                this.marked = false; // canceling the marked state...
                return fetchNextRecord(); // recursive call, not null!
            }
        }
